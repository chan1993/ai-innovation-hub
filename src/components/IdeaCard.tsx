    ...
    <Link href={`/idea/${idea.id}`} className="block group">
      <div className="relative bg-[#0d1430] border border-white/10 rounded-2xl p-6 hover:shadow-lg hover:shadow-black/30 hover:border-[#4f86f7]/40 transition-all duration-200 overflow-hidden">
        ...
        <div className="flex items-center gap-2 mb-3 flex-wrap">
          <span className="text-xs font-medium text-[#4f86f7] bg-[#4f86f7]/15 px-2.5 py-1 rounded-full">
            {idea.project}
          </span>
        ...
        <h3 className="text-white font-bold text-lg leading-snug mb-2 group-hover:text-[#4f86f7] transition-colors line-clamp-2">
          {idea.idea}
        </h3>

        <p className="text-white/55 text-sm leading-relaxed line-clamp-2 mb-4">{idea.outcome}</p>
